...
class OldStateMachine : public util::wrappers::TaskWithMemberFunctionBase
{
public:
    OldStateMachine(Display &display, StatusLeds &statusLeds, LedStrip &ledStrip, RealTimeClock &rtc,
